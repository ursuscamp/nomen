...
UTX=$(RUST_LOG=off cargo run -- name update --privkey $PRIVKEY smith 073e4dd94dd1128b964d45c2fba2fe4aca124df5 $TXID 0 $ADDR greg:$PUBKEY| grep "Unsigned Tx" | awk '{print $3}')
